    ...
    return (
        <section className="p-4 w-full bg-secondary rounded-2xl">
            <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-3">
                    <h3 className="text-accent text-h4 font-bold">Укажите цену</h3>
                ...
                <div className="flex flex-col gap-3">
                    <h3 className="text-accent text-h4 font-bold">Лаунчер</h3>
                    <div className="flex flex-col gap-3">
                        {launchers.map((item, index) => (
                            <button  key={index} onClick={() => setLauncherFilter(item)} type="button" className="flex items-center gap-3 text-h5">
                ...
                <div className="flex flex-col gap-3">
                    <h3 className="text-accent text-h4 font-bold">Жанр</h3>
                    <div className="flex flex-col gap-3">
                        {genres.map((item, index) => (
                            <button key={index} onClick={() => setGenreFilter(item)} type="button" className="flex items-center gap-3 text-h5">
